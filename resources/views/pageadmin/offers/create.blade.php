            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <h6 class="m-0 font-weight-bold text-primary">Crear Nueva Oferta para {{ $client->store_name }}</h6>
                        <a href="{{ route('clients.show', $client) }}" class="btn btn-sm btn-secondary">
                            <i class="fas fa-arrow-left"></i> Volver
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('offers.store', $client) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control @error('type') is-invalid @enderror" id="type"
                                            ...
                                            <option value="percentage" {{ old('type') == 'percentage' ? 'selected' : '' }}>
                                                Porcentaje de descuento</option>
                                            <option value="fixed_amount"
                                                {{ old('type') == 'fixed_amount' ? 'selected' : '' }}>Monto fijo de
                                                descuento</option>
                                            <option value="buy_x_get_y"
                                                {{ old('type') == 'buy_x_get_y' ? 'selected' : '' }}>Compra X lleva Y
                                            </option>
                                        </select>
                                        @error('type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="scope" id="scope_all"
                                                value="all" {{ old('scope', 'all') == 'all' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="scope" id="scope_product"
                                                value="product" {{ old('scope') == 'product' ? 'checked' : '' }}>
                                    ...
                                    <!-- Selector de Categoría (se muestra solo cuando se selecciona categoría) -->
                                    ...
                                    <!-- Selector de Producto (se muestra solo cuando se selecciona producto) -->
                            ...
                            <div class="mb-5">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4" id="discount-amount" style="display: none;">
